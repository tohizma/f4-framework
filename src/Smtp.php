...
class Smtp extends Magic
{
    ...
    public const    E_Header = '%s: header is required';
    public const    E_Blank = 'Message must not be blank';
    public const    E_Attach = 'Attachment %s not found';
    public const    E_DIALOG = 'SMTP dialog error: %s';
